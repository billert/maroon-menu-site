    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <div id="theresmore" className = "min-h-screen justify-center items-center flex flex-col pt-40">
        ...
        <Accordion variant = "bordered" itemClasses = {{title: "text-4xl"}}>
          ...
          <AccordionItem key="2" aria-label="Accordion 2" title={<motion.p style = {{originX: 0.5, originY: 0.5}}  initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ type: "spring", bounce: 0, duration: 0.5, delay: 0.15 }} className= "text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-[#59d5ff] to-[#00eaff] inline-block text-transparent bg-clip-text text-center pb-1">🚀 Change the menu while loading</motion.p>}>
          ...
          <AccordionItem key="5" aria-label="Accordion 5" title={<motion.p style = {{originX: 0.5, originY: 0.5}}  initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ type: "spring", bounce: 0, duration: 0.5, delay: 0.3 }} className= "text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-[#d73cef] to-[#7a28ff] inline-block text-transparent bg-clip-text text-center pb-1">📳 Haptic feedback</motion.p>}>
      ...
      <div id="tryit" className = "min-h-screen justify-center items-center flex flex-col pt-40">
        ...
        <motion.div className = "flex flex-row items-center justify-center gap-2 md:gap-5 mt-5 max-w-full p-2">
            ...
            <motion.a initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ type: "spring", bounce: 0, duration: 0.5, delay: 0.25 }} href="https://play.google.com/store/apps/details?id=com.billert.maroonmenu&pcampaignid=web_share">
              <Image src = "/google store.png" alt="Google Play Store Downlaod" width={220} height={100}></Image>
            </motion.a>
          </motion.div>
      </div>
